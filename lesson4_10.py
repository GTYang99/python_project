...
class Window(tk.Tk):
    def __init__(self):
        ...
        tk.Label(self,text="Old Password:",font=('arial',20)).grid(row=0,column=0,sticky=tk.E,pady=20)              #使用sticky讓文字對齊到左側
        ...
        tk.Entry(self,width=20,show="*",font=('arial',20)) .grid(row=2, column=1,padx=10)    #使用grid進行label與Entry布局 
